...
/**
 * RPSAbstract: Class which set up basic prompts and methods of the game. 
 */
public abstract class RPSAbstract implements RPSInterface {
    ...
    public boolean isValidMove(String move) {
        ...
        //iterate through possibleMoves with a loop
        for(int i=0; i<possibleMoves.length; i++) {
            //if moves is in possibleMoves, return true
    ...
    /**
     * Add one element to an array(String)
     * @param array array to get added
     * @param move string to be added to array
     */
    public void addElement(String[] array, String move) {

        //Iterate through the array to add original elements
    ...
    public void play(String playerMove, String cpuMove) {
        ...
        //Store outcome as int
        int outcome = determineWinner(playerMove, cpuMove);

        //Use addElement to add move to array
        addElement(playerMoves, playerMove);
        addElement(cpuMoves, cpuMove);
