 ...
 * 
 * This file contains the ticket class, which is part of the 
...
public class Ticket implements Comparable<Ticket>{
	...
	/**
	 * This method compare the order of tickets
	 */
	@Override
	public int compareTo(Ticket other){
		String thisType = this.getTicketType();
		String otherType = other.getTicketType();

		//check time if type equals
		if(orderMap.get(thisType).equals(orderMap.get(otherType))){
			return this.getCreatedAt().compareTo(other.getCreatedAt());
		}
		//check type
		else{
			return orderMap.get(thisType).compareTo(orderMap.get(otherType));
		}
	}
