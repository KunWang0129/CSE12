 ...
 * File description: This is a simplified version of MyLinkedList
 */

/**
 * This class contains all functions of MyLinkedList
 */
public class MyLinkedList<E> implements MyReverseList<E>{
     ...
     * @param arr - array of elements to be used to construct 
     * the LinkedList
     */
    ...
    /**
	 * A method that swaps nodes between fromIndex
     * and toIndex
     * @param fromIndex index of one node
     * @param toIndex index of another node
	 */
    public void reverseRegion(int fromIndex, int toIndex){
        ...
        for(int i = 0; i<1+(toIndex-fromIndex)/2; i++){
            Object Hold = this.get(fromIndex+i);
            this.getNth(fromIndex+i).setElement(this.get(toIndex-i));
            this.getNth(toIndex-i).setElement((E)Hold);
        }
    }
